...
export type EditorElement = {
  ...
  name: string
  type: EditorBtns
  content: EditorElement[] | { href?: string; innerText?: string; src?: string, value?: string, variant?: BtnVariants, type?: string }
}
  ...
  switch (action.type) {
    case 'ADD_ELEMENT':
      ...
      case 'REORDER_CHILD_ELEMENTS': {
        ...
        const reorderElementsInContainer = (elements: EditorElement[]): EditorElement[] => {
